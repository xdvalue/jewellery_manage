...
import com.els.jewellery.manage.core.shiro.ShiroDbRealm;
...
public class ShiroConfig {
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "custom", name = "spring-session-open", havingValue = "true")
     ...
     */
    @Bean
    @ConditionalOnProperty(prefix = "custom", name = "spring-session-open", havingValue = "false")

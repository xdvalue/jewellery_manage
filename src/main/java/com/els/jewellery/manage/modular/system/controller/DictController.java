...
import com.els.jewellery.manage.modular.system.dao.DictDao;
import com.els.jewellery.manage.modular.system.service.IDictService;
import com.els.jewellery.manage.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
	 ...
	 *            格式例如 "1:启用;2:禁用;3:冻结"
	 */
	@BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = com.els.jewellery.manage.common.constant.Dict.DictMap)
	...
	@BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = com.els.jewellery.manage.common.constant.Dict.DictMap)
	 ...
	 * 删除字典记录
	 */
	@BussinessLog(value = "删除字典记录", key = "dictId", dict = com.els.jewellery.manage.common.constant.Dict.DeleteDict)

...
function selectDetailById(id) {
	var ajax = new $ax(Feng.ctxPath + "/geminfo/gem/detail", function (data) {
        if (data.data != null && data.data != undefined) {
        	$("#reportCode").val(data.data.reportCode);
...
function save(){
	...
	var gemInfo = {"id":$("#id").val(),"gemName":gemName,"gemWeight":gemWeight,"gemColour":gemColour,
			...
			"gemParamRemark":gemParamRemark,"gemImg":gemImg,"gemQrcodeB":gemQrcodeB,"batchId":batchId,"batchCode":batchCode,"gemParamImg1":gemParamImg1,
